...
# import deepspeed
import random
from graphsage_model_full_arxiv import  GraphSAGE
...
from load_graph import load_ogbn_mag,load_ogbn_dataset_full
...
def run(args, device, data):
		# Unpack data
	g, nfeats, labels, n_classes, train_nid, val_nid, test_nid, evaluator, split_idx = data
	...
	model = GraphSAGE(in_feats=nfeats.size(-1),
...
def load_train(args):
	...
	if args.dataset=='ogbn-arxiv':
		data = load_ogbn_dataset_full(args.dataset,  args)
