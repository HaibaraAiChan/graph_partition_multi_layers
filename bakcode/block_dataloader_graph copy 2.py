...
def generate_dataloader_wo_gp_Pure_range(raw_graph, block_to_graph_list, args):
	...
	for layer, block_to_graph in enumerate(block_to_graph_list):
		...
		# print(src_nids)
		current_block_eidx_raw, current_block_edges_raw = get_global_graph_edges_ids_2(raw_graph, block_to_graph)
		# block_to_graph.edata['_ID'] = current_block_eidx_raw  # raw global edata
		# print(' layer edges')
		# print(sorted(current_block_eidx_raw.tolist()))

		if layer ==0:
			print(current_block_eidx_raw)
			print(current_block_edges_raw[0].tolist())
			print(current_block_edges_raw[1].tolist())
			print(src_nids)
